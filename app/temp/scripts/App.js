...
var RevealOnScroll = function () {
    function RevealOnScroll(els, offset) {
        ...
        /* the constructor method is ran immediately once when page load */
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function createWaypoints() {
            var that = this; /* points to the instance of 'RevealOnScroll' */
            /* we create a waypoint for each of 4 feature items */
            this.itemsToReveal.each(function () {
                /* everything we include here will run once for each element */
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* Purpose of the 'createHeaderWaypoint()' method is to change the background-color of the desktop */
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.lazyImages = (0, _jquery2.default)(".lazyload"); /* selects all element on a page that have a class 'lazyload' */
        /* 'createHeaderWaypoint()' method */
        this.siteHeader = (0, _jquery2.default)(".site-header"); /* property that points towards the site header DOM element */
        this.headerTriggerElement = (0, _jquery2.default)(".large-hero__title"); /* we will draw a darker background-color menu bar when reaching this DOM element */
        this.createHeaderWaypoint();
        /* 'createPageSectionWaypoints()' method */
        this.pageSections = (0, _jquery2.default)(".page-section"); /* jquery selector to select all the different sections of the web site inside one variable */
        this.headerLinks = (0, _jquery2.default)(".primary-nav a"); /* jquery selector to select all <a> elements of the navigation menu inside one variable */
    ...
    _createClass(StickyHeader, [{
        ...
        value: function refreshWaypoints() {
            this.lazyImages.on('load', function () {
                /* on the 'load' event for any of the lazyImages */
        ...
        value: function addSmoothScrolling() {
            /* we apply smooth scrolling to each navigation menu link */
        ...
        value: function createHeaderWaypoint() {
            ...
            new Waypoint({
                ...
                handler: function handler(direction) {
                    /* add a modifier class to the header so we can style it to use a darker background */
                    if (direction == "down") {
                ...
                new Waypoint({ /* when scrolling down */
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            ...
                            (0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); /* link of current section is put in yellow */
                        }
                    },
...
var Modal = function () {
    function Modal() {
        ...
        this.openModalButton = (0, _jquery2.default)(".open-modal"); /* point to 'Get in Touch' button in the navigation bar */
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            //pushes any key
            (0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); /* event is fired if user presses any key in the page  */
        }
    }, {
        key: "keyPressHandler",
        value: function keyPressHandler(e) {
            if (e.keyCode == 27) {
                /* if key pressed is the <escape> key */
                this.closeModal();
            }
        }
    }, {
